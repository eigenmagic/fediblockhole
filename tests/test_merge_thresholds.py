...
def test_mergeplan_count_2():
    ...
    bl_1 = Blocklist(
        "test01",
        {
            "onemention.example.org": DomainBlock(
                "onemention.example.org", "suspend", "", "", True, True, True
            ),
            "twomention.example.org": DomainBlock(
                "twomention.example.org", "suspend", "", "", True, True, True
            ),
            "threemention.example.org": DomainBlock(
                "threemention.example.org", "suspend", "", "", True, True, True
            ),
        },
    )
    ...
    bl_3 = Blocklist(
        "test3",
        {
            "threemention.example.org": DomainBlock(  # noqa
                "threemention.example.org", "suspend", "", "", True, True, True
            ),
            "threemention.example.org": DomainBlock(  # noqa
                "threemention.example.org", "suspend", "", "", True, True, True
...
def test_mergeplan_pct_30():
    ...
    bl_1 = Blocklist(
        "test01",
        {
            ...
            "fourmention.example.org": DomainBlock(
                "fourmention.example.org", "suspend", "", "", True, True, True
            ),
        },
    )
    ...
    ml = merge_blocklists(
        [bl_1, bl_2, bl_3, bl_4], "max", threshold=30, threshold_type="pct"
    )
...
def test_mergeplan_pct_55():
    ...
    ml = merge_blocklists(
        [bl_1, bl_2, bl_3, bl_4], "max", threshold=55, threshold_type="pct"
    )
